...
<div class="row">
    ...
    <div class="col-md-5 col-lg-6">
        ...
        <div class="row" style="background-color: lavender">
            <div class="col-md-2">
                <div class="row">
                    <div class="col-lg-4"><input type="button"  value="${post.id}" onclick="doDecAjax(${post.id}, 'dec', '${username}')" class="but5"/></div>
                    <div  class="col-lg-4"><p id="commentRate${post.id}"> <strong><c:out value="${post.rate}"/></strong></p></div>
                    <div class="col-lg-4"><input type="button"  value="${post.id}" onclick="doDecAjax(${post.id}, 'inc', '${username}')" class="but3"></div>

                </div>

            </div>
            <div class="col-md-8 col-lg-10"><a href="/article/${post.id}"><strong><c:out value="${post.name}"/></strong></a></div>
        </div>
        <div class="row" style="background-color: lavender">
            <div class="col-md-2"></div>
            <div class="col-md-3"><c:out value="${post.date}"/> </div>
        ...
        <div class="row" style="background-color: lavender">
            ...
            <div class="row">
                <div class="col-md-12"><a href="#" >Комментарии: ${post.comments.size()}</a></div>
            </div>
            </br>
